<script>
	export let showEarth = false;
</script>
{#if showEarth}<option value="ALL">ALL</option>{/if}
...
<option value="AP">[AP] Asia (Unknown Country)</option>
...
<option value="BQ">[BQ] Bonaire/Sint Eustatius/Saba</option>
...
<option value="EU">[EU] Europe (Unknown Country)</option>
...
<option value="LA">[LA] Lao Peoples Democratic Republic</option>
